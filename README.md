...
| ------ | -------------- | ------ | ------------- | -------------------- | ------------------------- | ------------------------------- | ------ | ------ | ------ |
| master | 192.168.31.240 | master | 8U/16G/120G   | dell笔记本安装centos | wifi无线 | Win32DiskImager制作启动盘 | CentOS-8.3.2011-x86_64-dvd1.iso | root | 123456 |
| worker node01  | 192.168.31.209 | node01 | 2U/4G/40G     | Vmware安装           | 桥接模式       | Vmware 创建虚拟机         | CentOS-8.3.2011-x86_64-dvd1.iso | root | 123456 |
| worker node02 | 192.168.31.214 | node02 | 2U/4G/40G     | Vmware安装           | 桥接模式       | Vmware 创建虚拟机         | CentOS-8.3.2011-x86_64-dvd1.iso | root | 123456 |
